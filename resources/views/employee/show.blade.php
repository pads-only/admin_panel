<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 dark:text-gray-200 overflow-hidden shadow-sm sm:rounded-lg p-4 ">
                ...
                <h1 class="text-4xl">Name: {{$employee->first_name . $employee->last_name}}</h1>
                <small>Company: {{$employee->companies->name}}</small>
